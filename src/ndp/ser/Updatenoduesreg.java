...
import java.sql.*;
/**
 * Servlet implementation class Updatenoduesreg
 */
@WebServlet("/Updatenoduesreg")
public class Updatenoduesreg extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String str="update record set accsec=?,sgca=?,ncc=?,nss=?,library=?,itrc=?,pti=?,department=?,vehicle=?,subhash=?,raman=?,tagore=?,vs=?,ambedkar=?,saraswati=?,sarojini=? where regno=?";
		try
		{
