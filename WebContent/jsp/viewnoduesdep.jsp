...
<table width="1000px">
<tr><th>ROLLNO.</th><th>REG.NO.</th><th>NAME</th><th>FATHER NAME</th></tr>
<%
...
String str="select * from record where session=? and branch=?";
try
{
	...
	{
		%>
		<tr><td><%=rs.getLong("rollno") %></td><td><%=rs.getString("regno") %></td><td><%=rs.getString("name") %></td><td><%=rs.getString("parent") %></td></tr>
	    <%
	}
}
