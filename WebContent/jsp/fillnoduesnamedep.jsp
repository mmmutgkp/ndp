...
String str="select * from record where name=? and branch=?";
try
{
...
<font face="Segoe UI" color="black" size="3px"><%=rs.getLong("rollno")%></font>
</div>
<div id="phone-outer" style="top: 29%;left: 21%;width: 10%;height: 5%;position: absolute;border-radius: 0px;padding-left: 40px;padding-top: 2px;box-shadow: 0px 0px 10px 1px #888888;"><font face="Segoe UI" color="white" size="3px">Roll Number</font></div>
...
<font face="Segoe UI" color="black" size="3px"><%=name%></font>
</div>
