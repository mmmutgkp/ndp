...
String regno=request.getParameter("txtreg");
		...
		try
		{
			...
			{
				%>
				<form action="/ndp/Updatenoduesreg" method="post">
				<input type="hidden" value=<%=regno%> name="txtid">
				<table width="500px">
				<tr><th>Registration No.</th><th>:</th><th><%=rs.getString("regno") %></th></tr>
			...
			{
				response.sendRedirect("/ndp/jsp/searchreg.jsp?msg=Not found in database!!");
			}
		}
