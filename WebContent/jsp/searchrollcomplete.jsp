...
{   
    ...
    {
      alert("Roll No. should not be left blank");
      document.frm.txtroll.focus();
      return false;
    }
    else if(!roll.match(letters))
	{
...
<font face="arial rounded MT">Enter Roll No.</font>
<br>
<br>
<form name="frm" method="get" action="/ndp/jsp/rollnocomplete.jsp" onSubmit="return validateForm()">
