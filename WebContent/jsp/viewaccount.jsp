...
<table width="1100px">
<tr><th align="left">REG.NO.</th><th align="left">ROLL NO.</th><th align="left">NAME</th><th align="left">FATHER NAME</th><th align="left">ACCOUNT NO.</th><th align="left">MOBILE NO.</th></tr>
<%
Connection con=null;
...
try
{
	...
	{
	%>
		<tr><td><%=rs.getString("regno") %></td><td><%=rs.getLong("rollno") %></td><td><%=rs.getString("name") %></td><td><%=rs.getString("parent") %></td><td><%=rs.getLong("accountno") %></td><td><%=rs.getLong("Mobile") %></tr>
	<%
	}
