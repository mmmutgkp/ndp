...
<br>
<br>
<font face="Segoe UI">Excel File</font>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="file" name="file"/>
<br><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" value="UPLOAD" class="btn-style"/>
</form>
</div>
<div id="phone-outer" style="top: 30%;left: 10%;width: 36%;height: 5%;position: absolute;background-color: #336699;border-radius: 5px;box-shadow: 0px 10px 10px 5px #888888;padding-left: 10px">
<font face="Segoe UI" size="4px" color="white">Upload Record</font>
</div>
<div  style="top: 30%;left: 50%;width: 30%;height: 60%;position: absolute;background-image:-webkit-linear-gradient(top,#F5F5F5 0%, #D3D3D3 100%);box-shadow: 0px 0px 10px 5px #888888;background-image:-moz-linear-gradient(top,#F5F5F5 0%, #D3D3D3 100%);background-image:-ms-linear-gradient(top,#F5F5F5 0%, #D3D3D3 100%);border-radius: 10px;padding-left: 90px;padding-top: 25px">
<div style="top: 0%; left: 0%;width: 100%; height: 100%;position: absolute;background-image: url('/ndp/img/excel.JPG')">
</div>
</div>
<div id="phone-outer" style="top: 30%;left: 50%;width: 36%;height: 5%;position: absolute;background-color: #336699;border-radius: 5px;box-shadow: 0px 10px 10px 5px #888888;padding-left: 10px">
<font face="Segoe UI" size="4px" color="white">Excel sheet must be of this type in .xls format</font>
</div>
</body>
</html>