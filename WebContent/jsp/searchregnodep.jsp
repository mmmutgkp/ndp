...
{   
	...
	var roll=document.frm.txtreg.value;
    if(document.frm.txtreg.value=="")
    {
      document.getElementById("divi").innerHTML="Registration number should not be left blank.";
...
<div  style="top: 40%;left: 34.2%;width: 30%;height: 30%;position: absolute;background-image:-webkit-linear-gradient(top,#F5F5F5 0%, #D3D3D3 100%);box-shadow: 10px 10px 5px #888888;background-image:-moz-linear-gradient(top,#F5F5F5 0%, #D3D3D3 100%);background-image:-ms-linear-gradient(top,#F5F5F5 0%, #D3D3D3 100%);border-radius: 10px;padding-left: 35px;padding-top: 25px">
<br>
<br>
<form name="frm" method="get" action="/ndp/jsp/fillnoduesregdep.jsp" onSubmit="return validateForm()">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="txtreg" class="textbox">
<br>
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="SUBMIT" class="btn-style">
</form>
</div>
<div id="phone-outer" style="top: 38%;left: 34%;width: 32%;height: 5%;position: absolute;border-radius: 5px;box-shadow: 5px 5px 5px #888888;padding-left: 10px"><font face="Segoe UI" size="4px" color="white" >Enter Registration Number</font></div>
