...
{   
	...
	var roll=document.frm.txtname.value;
    if(document.frm.txtname.value=="")
    {
      document.getElementById("divi").innerHTML="Name should not be left blank.";
...
<br>
<br>
<form name="frm" method="get" action="/ndp/jsp/fillnoduesname.jsp" onSubmit="return validateForm()">
...
<div id="phone-outer" style="top: 38%;left: 34%;width: 32%;height: 5%;position: absolute;border-radius: 5px;box-shadow: 5px 5px 5px #888888;padding-left: 10px"><font face="Segoe UI" size="4px" color="white" >Enter Student Name</font></div>
