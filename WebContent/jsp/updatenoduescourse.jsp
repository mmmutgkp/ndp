...
if(sessions.equals("def") && course.equals("def") && branch.equals("def"))
{
...
if(!sessions.equals("def") && course.equals("def") && branch.equals("def"))
{
String str="select * from record where session=?";
try
{
	ps=con.prepareStatement(str);
...
else if(!sessions.equals("def") && !course.equals("def") && !branch.equals("def"))
{
	String str="select * from record where session=? and course=? and branch=?";
	try
	{
		ps=con.prepareStatement(str);
		ps.setString(1,sessions);
...
{
	String str="select * from record where session=? and course=?";
	try
	{
		ps=con.prepareStatement(str);
		ps.setString(1,sessions);
...
{
	String str="select * from record where course=?";
	try
	{
		ps=con.prepareStatement(str);
